...
do
    ...
    --map_name ${map} --seed ${seed} --n_training_threads 1 --n_rollout_threads 8 --num_mini_batch 1 --episode_length 250 \
    --num_env_steps 10000000 --ppo_epoch 15 --clip_param 0.05 --use_value_active_masks --use_eval --eval_episodes 32 \
    --use_hetero_graph --hidden_size 64 --neighbor_dim 8 --agent_state_dim 120 \
    --landmark_dim 4 --num_agents 3 --n_allies 2 --n_enemies 5 \
