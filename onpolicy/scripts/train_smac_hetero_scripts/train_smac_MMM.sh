...
do
    ...
    --map_name ${map} --seed ${seed} --n_training_threads 1 --n_rollout_threads 8 --num_mini_batch 1 --episode_length 150 \
    ...
    --landmark_dim 4 --num_agents 10 --n_allies 9 --n_enemies 10 \
